...
class UsersTable extends Table
{
    ...
    public function validationRegister(Validator $validator): Validator
    {
        ...
        $validator
            ->minLength('password', 8, __('The password must contain at least 8 characters') . '.')
            ->requirePresence('password', 'create')
            ->notEmptyString('password');

        $validator
            ->minLength('password_match', 8, __('The confirm password must contain at least 8 characters') . '.')
            ->requirePresence('password_match', 'create')
            ->notEmptyString('password_match');

        $validator
            ->sameAs('password', 'password_match', __('The passwords are not matching. Please, try again!'));
